...
\geometry{left=1.4cm, top=0.9cm, right=1.2cm, bottom=1.0cm}
\pagestyle{empty}
\urlstyle{same}
...
\newcommand{\resumeItemListStart}{\begin{itemize}\small\setlength{\itemsep}{0mm}}
...
\begin{minipage}[t]{2.55cm}
  \vspace{0pt}
  \includegraphics[width=2.45cm,height=3.25cm,keepaspectratio]{id_photo.jpg}
\end{minipage}
\hfill
...
\cvsection{个人介绍}
\small{
我是中国科学技术大学计算机科学与技术学院二年级硕士生，导师为邵帅教授。本科毕业于山东大学计算机科学与技术学院泰山学堂（计算机）。我的研究兴趣主要在理论计算机科学，尤其关注 counting complexity 中的 Holant 问题，以及 Holant 或 edge CSP 框架下判定问题和优化问题的复杂性分类。此前我接受过较系统的数学与算法训练，在数据结构、算法设计、计算理论等课程中取得较好成绩，也参与过程序设计竞赛和算法相关科研训练。
}
...
\cvsection{荣誉奖项}
\resumeSubHeadingListStart
  \resumePOR{山东大学三好学生}{前 5\%}{2021.12}
  \resumePOR{山东大学学业一等奖学金}{前 5\%}{2021.12}
  \resumePOR{山东大学玲珑集团奖学金}{前 5\%}{2021.12}
  \resumePOR{全国大学生数学建模竞赛省一等奖}{前 10\%}{2022.11}
  \resumePOR{全国高中数学奥林匹克竞赛省级赛区一等奖}{}{2019}
\resumeSubHeadingListEnd
